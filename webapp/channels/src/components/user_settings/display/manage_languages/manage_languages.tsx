            ...
            <div key='changeLanguage'>
                ...
                <div>
                    ...
                    <FormattedMessage
                        ...
                        defaultMessage='Select which language Konnect displays in the user interface.'
                    />
                    <p/>
                    <FormattedMessage
                        id='user.settings.languages.promote2'
                        defaultMessage='Would you like to help with translations? Join the <link>Konnect Translation Server</link> to contribute.'
                        values={{
