...
export default function ChannelHeaderText(_props: Props) {
    // Hide header description text in all channel types
    return null;

    // Commented out - Original logic preserved for future use
    ...
    // // Don't show header text for Direct or Group channels
    // if (isDirectChannel || isGroupChannel) {
    //     return null;
    // }

    // // If it has a channel header text then show it (but not for Direct/Group channels)
    // if (hasHeaderText) {
    //     return (
    ...
    // // Direct and Group channels should not show header text or add button
    // if (isDirectChannel || isGroupChannel) {
    //     return null;
    // }
