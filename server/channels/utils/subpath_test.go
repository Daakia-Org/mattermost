...
const baseManifestJSON = `{
  ...
  "display": "standalone",
  "start_url": ".",
  "description": "Daakia is an Chat application like teams with video conferencing",
